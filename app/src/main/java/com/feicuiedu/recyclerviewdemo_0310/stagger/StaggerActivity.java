...
public class StaggerActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        //设置item的点击事件
        mStaggerAdapter.setOnItemClickListener(new LinearAdapter.OnItemClickListener() {
            @Override
        ...
        //长按事件
        mStaggerAdapter.setOnItemLongClickListener(new LinearAdapter.OnItemLongClickListener() {
            @Override
